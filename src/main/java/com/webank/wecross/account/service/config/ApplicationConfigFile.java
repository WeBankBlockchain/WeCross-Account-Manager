...
public class ApplicationConfigFile {
    private static Logger logger = LoggerFactory.getLogger(ApplicationConfigFile.class);

    public Service service;
    public Auth auth;

    public static ApplicationConfigFile parseFromFile(String filePath)
            throws ConfigurationException {
        Toml toml = FileUtility.readToml(filePath);
        ApplicationConfigFile config = new ApplicationConfigFile(toml);
        return config;
    }

    public ApplicationConfigFile(Toml toml) throws ConfigurationException {
